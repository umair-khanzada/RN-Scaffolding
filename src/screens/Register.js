          ...
          <View>
            ...
            <Input
              ...
              rightIcon={
                ...
                onPressHandler={this.handleToggle('confirmPasswordSecureTextEntry')}
            ...
            <Link message="Already have an account?" text="Login Here" onPress={navigateTo(this.props.navigation, 'Login')}/>
          </View>
        </View>
      </ScrollView>
    )
