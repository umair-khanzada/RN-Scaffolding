      ...
      <View style={[styles.container]}>
        ...
        <View style={{flex: 3}}>
          ...
          <View style={styles.flexRow}>
            <View>
              <CheckBox title="Remember me" checked={this.state.rememberMe} onPress={this.handleToggle('rememberMe')}/>
            </View>
            <Link text="Forgot Password!" onPress={navigateTo(this.props.navigation, 'ForgotPassword')}/>
          </View>
          <Button title="Login" onPress={navigateTo(this.props.navigation, 'App')}/>
